...
public partial class MainWindow : Window
{
    ...
    {
        var algorithm = _vm.EncryptionAlgorithm;
    ...
    {
        var algorithm = _vm.HashAlgorithm;
            ...
            switch (btn.Name)
            {
                case "btnFileBrowse":
                    ...
                    if (ofd.ShowDialog(this) == true)
                    {
                        ...
                        _vm.Filename = ofd.FileName;
                    }
                    break;
                case "btnOutputBrowse":
                    var sfd = new SaveFileDialog
                    {
                        DefaultExt = _vm.EncryptionAlgorithm.GetDefaultExt()
                    };
