...
public class ArgonHash(int degreesOfParallelism, int argon2Iterations, int memorySize, int saltLength, int hashLength) : IHash
{
    private readonly int _argon2Iterations = argon2Iterations;
    private readonly int _degreesOfParallelism = degreesOfParallelism;
    private readonly int _hashLength = hashLength;
    ...
    public async Task<bool> CheckHashAsync(string clearText, string hash)
    {
        ...
        // starts with the separator so a length of 9 is needed.
